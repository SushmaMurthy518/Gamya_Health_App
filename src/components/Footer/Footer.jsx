  ...
  return (
          ...
          <div className='d-row d-md-flex justify-content-between align-items-center'>
            ...
            <div className='col-12 col-md-6 col-lg-7'>
              <ul className='list-unstyled mb-0'>
                <li>
                  <p>Main Address - 47/1,Vijaynagar,Bangalore,  Karnatakat,India</p>
                </li>
                <li>
                  <p>Phone Number - +91 900800700</p>
                </li>
                <li>
                  <p>Email - healthcarw@.com</p>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div className='bg-body-tertiary'>
      <div className='container'>
        <p className='p-3 m-0 text-center'>copyright @ Aarav ed tech</p>
      </div>
    </div>
  </footer>
  )
